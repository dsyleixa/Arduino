...
#define PIN_OUT1     12 /*D6*/               //  out Alarmanlage ext
#define PIN_OUT2     27 /*D8*/               //  out Alarmanlage int
#define PIN_OUT3     33 /*D4*/               //  Alarm-Sirene pwm/tone
...
// ESP8266WebServer webserver(8081);    // #include <ESP8266WebServer.h>
WebServer    webserver(8081);           // #include <ESPWebServer.h>
