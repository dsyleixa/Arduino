...
WiFiServer   wifiserver(8008);
WebServer    webserver(8008);
...
void handleWebsite() {  
   ...
   String script="";
   String website_title = "ford.sytes.net";
         ...
         if (client.available()) {             // if there's bytes to read from the client,
            ...
            if (c == '\n') {                   // if the byte is a newline character
               ...
               if (currentLine.length() == 0) {
                  ...
                  script += "<head> \n";
                  // autom. Aktualisierung alle 5 sec.
                  script += "<meta http-equiv=\"refresh\" content=\"5\" > \n" ;
                  ...
                  script += "<h1>My First WebServer with ESP32 - Station Mode &#128522;</h1> \n";
            ...
            if (currentLine.endsWith("GET /OUT1H")) {
               OUT1=HIGH;               // GET /H turns the LED on
            }
            if (currentLine.endsWith("GET /OUT1L")) {
               OUT1=LOW;               // GET /L turns the LED off
            }
...
void setup() {
   ...
   display.setTextColor(WHITE);
   display.setCursor(0, tftline); display.print("  HTTP webserver started!");
   tftline+=15;
   delay(1);
