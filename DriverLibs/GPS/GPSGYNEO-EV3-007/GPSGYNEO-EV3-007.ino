...
{ 
  ...
  if (gps.location.isValid())
  {
    ...
    databuf[4]=(byte)decdeg-10;                         // Latt
    databuf[5]=(byte)decmin;
    databuf[6]=lowbyte(Iintpart);
    databuf[7]=lowbyte(Ifracpart); 
    ...
    sprintf(sbuf, "Latt: %+04d:%02d'%7.4f ", decdeg-10, decmin, fdecsec);
    Serial.print(sbuf); 
    lcdprintxy(0, 60, sbuf);
