...
//
#define ENC0          4  // motorenc 0 // 3 encoders: 32-bit
#define ENC1          8  // motorenc 1
#define ENC2         12  // motorenc 2
//
#define DOUBLE0      16  // 64bit double (8 byte)
#define DOUBLE1      24  // 64bit double (8 byte)
#define FLOAT0       32  // 32bit float (4 byte)
#define FLOAT1       36  // 32bit float (4 byte)
#define FLOAT2       40  // 32bit float (4 byte)
//
#define ANA0         44  // analog 0   // 9 analog: 16-bit ADC
...
//
#define TERMINUS     63  // end of transmission array 0xfe
