...
#define PIN_OUT1     D6               //  out Alarmanlage int
#define PIN_OUT2     D8               //  out Alarmanlage ext
...
String c1OUT1name = "1-F.TÜR";   // c1 output name  
String c1OUT2name = "2-F.TÜR";

String c2OUT1name = "1-F.TÜR";   // c2 output name  
String c2OUT2name = "2-F.TÜR";

String c3OUT1name = "1-F.TÜR";   // c3 output names
...
String svSECTION1name = "Heim.1";
String svSECTION2name = "Heim.2";

String CLIENT0name  = "c0 GEW.-HAUS";
String c0SECTION1name = "Aussen";
String c0SECTION2name = "GH Innen";

String CLIENT1name  = "c1 KELLER";
String c1SECTION1name = "Gefr";
String c1SECTION2name = "Kühl";

String CLIENT2name  = "c2 KÜCHE";
String c2SECTION1name = "Gefr";
String c2SECTION2name = "Kühl";

String CLIENT3name  = "c3 GEW.-HAUS";
String c3SECTION1name = "Aussen";
String c3SECTION2name = "GH Innen";
...
void dashboard(int mode) {
   ...
   if (mode == 0)  {
      ...
      lcd.setCursor(0,0); lcd.print("c0 Rauch : "+(String)(c0espA0.vact ));
      lcd.setCursor(0,1); lcd.print("c1 Rauch : "+(String)(c1espA0.vact ));
      lcd.setCursor(0,2); lcd.print("c2 Rauch : "+(String)(c2espA0.vact ));
      lcd.setCursor(0,3); lcd.print("c3 Rauch : "+(String)(c3espA0.vact ));       
   }   
      ...
      lcd.setCursor(0,3); lcd.print("  Rauch   = " + (String)c0espA0.sact + " %");
   }
      ...
      lcd.setCursor(0,3); lcd.print("Rauch:    " + (String)c1espA0.sact+ "%" );     
   }   
      ...
      lcd.setCursor(0,3); lcd.print("Rauch:    " + (String)c2espA0.sact+ "%" );   
   }
      ...
      lcd.setCursor(0,3); lcd.print("  Rauch   = " + (String)c3espA0.sact + " %");
   }
      ...
      lcd.setCursor(0,2); lcd.print("Svr Innen T = " + (String)t1.sact + "'C");
      lcd.setCursor(0,3); lcd.print("    Rauch   = " + (String)espA0.sact + "%");        
   }   
...
void handleWebsite() {
   ...
   */  
   ...
   // Zeile 1 Server
   script +=      "<tr> ";
   script +=         "<td bgcolor='Peru'> " + svSECTION1name + " </td>";
   ...
   script +=         "<td bgcolor='orange'>" + (String)A1muxname + " % </td>"; 
   script +=     "</tr> ";
   script +=     "</thead> ";
   ...
   if (espA0.vact>=fSmokeLIMIT) {
      script += (String)"<td bgcolor='red'>";
   } else script += (String)"<th>";  
   script +=                  (String)espA0.sact + "</th> ";
   script +=           "<th>"+(String)(int)round(espA0.vmean) + "</th> ";
   ...
   */
   ...
   // Zeile 1 Client 0
   script +=      "<tr> ";
   script +=         "<td bgcolor='Peru'> " + c0SECTION1name + " </td>";
   script +=         "<td bgcolor='Yellow'> °Cmin  </td>";
   script +=         "<td bgcolor='Yellow'> °Cmax  </td>";
   script +=         "<td bgcolor='White'> rF%  </td>";
   script +=         "<td bgcolor='Avocado'>  " + c0SECTION2name + " </td>";
   script +=         "<td bgcolor='Yellow'> °Cmin  </td>";
   script +=         "<td bgcolor='Yellow'> °Cmax  </td>";
   script +=         "<td bgcolor='White'> rF%  </td>";
   ...
   */
   ...
   script +=     "<thead> ";
   script +=       "<tr> ";
   script +=       "<td bgcolor='Teal'> " + c1SECTION1name + "  </td>";
   script +=       "<td bgcolor='Yellow'> °Cmin  </td>";
   script +=       "<td bgcolor='Yellow'> °Cmax  </td>";
   script +=       "<td bgcolor='Yellow'> °C ∅  </td>";
   script +=       "<td bgcolor='White'> rF%   </td>";
   script +=       "<td bgcolor='LightCyan'>  " + c1SECTION2name + " </td>";
   script +=       "<td bgcolor='Yellow'> °Cmin </td>";
   script +=       "<td bgcolor='Yellow'> °Cmax </td>";
   script +=       "<td bgcolor='White'> rF%  </td>";
   ...
   script +=  "<thead> ";
   script +=    "<tr> ";
   script +=    "<td bgcolor='Teal'> " + c2SECTION1name + "  </td>";
   script +=    "<td bgcolor='Yellow'> °Cmin  </td>";
   script +=    "<td bgcolor='Yellow'> °Cmax  </td>";
   script +=    "<td bgcolor='Yellow'> °C ∅  </td>";
   script +=    "<td bgcolor='White'> rF%   </td>";
   script +=    "<td bgcolor='LightCyan'>  " + c2SECTION2name + " </td>";
   script +=    "<td bgcolor='Yellow'> °Cmin </td>";
   script +=    "<td bgcolor='Yellow'> °Cmax </td>";
   script +=    "<td bgcolor='White'> rF%  </td>";
   ...
   // Zeile 1 Client 3
   script +=      "<tr> ";
   script +=         "<td bgcolor='Peru'> " + c3SECTION1name + " </td>";
   script +=         "<td bgcolor='Yellow'> °Cmin  </td>";
   script +=         "<td bgcolor='Yellow'> °Cmax  </td>";
   script +=         "<td bgcolor='White'> rF%  </td>";
   script +=         "<td bgcolor='Avocado'>  " + c3SECTION2name + " </td>";
   script +=         "<td bgcolor='Yellow'> °Cmin  </td>";
   script +=         "<td bgcolor='Yellow'> °Cmax  </td>";
   script +=         "<td bgcolor='White'> rF%  </td>";
   script +=         "<td bgcolor='White'>   -   </td>";
   ...
   // Zeile 4 Client 3
   //strcpy(dsymbol, tendencysymbol(c3p1.vact - c3p1.vmean) );
   script +=  "<tr> ";
   script +=      "<th>" + (String)"  -  " + "</th> ";   
...
void handleClients() {
   ...
   // re CLIENT 3
   message += (String)"&c3t1=" + c3t1.sact + "&c3h1=" + c3h1.sact;
   message += (String)"&c3t2=" + c3t2.sact + "&c3h2=" + c3h2.sact;
   message += "&c3out1=" + (String)c3out1 + "&c3out2=" + (String)c3out2; 
   /*message += "&c3out3=" + (String)c3out3 ;*/
