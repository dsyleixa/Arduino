...
static vlog c2t1, c2h1, 
            ...
            c2p1, c2q1, c2espA0;    // local barometr.air pressure, quality 
...
char * dashboard(int mode) {
  ...
  if(mode==1) {   
       ...
       display.setCursor( 0,20);  display.print("Cooler " + (String)c2t2.sact +  "*C");   // <<<<<<<<<<<    
       display.setCursor( 0,32);  display.print("Freezr " + (String)c2t1.sact +  "*C" );  // <<<<<<<<<<<
       display.setCursor( 0,44);  display.print("Smoke  " + (String)c2espA0.sact + "%" );        
