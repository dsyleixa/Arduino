...
int checkAlarms() {
   ...
   if(svespA0.vact>=fSmokeLIMIT) {  tempEmergencyCnt++; }
   if(c0espA0.vact>=fSmokeLIMIT) {  tempEmergencyCnt++; }
   if(c1espA0.vact>=fSmokeLIMIT) {  tempEmergencyCnt++; }
   if(c2espA0.vact>=fSmokeLIMIT) {  tempEmergencyCnt++; }
   if(c3espA0.vact>=fSmokeLIMIT) {  tempEmergencyCnt++; }
   digitalWrite(PIN_OUT3, 0);
   if(  (svespA0.vact>=fSmokeLIMIT) 
     || (c0espA0.vact>=fSmokeLIMIT) 
     || (c1espA0.vact>=fSmokeLIMIT) 
     || (c2espA0.vact>=fSmokeLIMIT) 
     || (c3espA0.vact>=fSmokeLIMIT)) 
     { tone(PIN_OUT3, 440, 250); delay(500); }
...
void dashboard(int mode) {
   ...
   if (mode == 0)  {
      ...
      display.setCursor( 0, 60);  display.print("    Rauch   = " + (String)svespA0.sact + "%");   
      ...
      lcd.setCursor(0,3); lcd.print("    Rauch   = " + (String)svespA0.sact + "%");
   }
...
void handleClients() {
   ...
   //message += "&c3out3=" + (String)c3out3 ;   // intern auto ctrl 
