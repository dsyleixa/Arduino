...
void handleWebsite() {
   ...
   if (validPath) {
     ...
     if ((method == "GET") && (path == "/c0tx3=UP"))  { c0tx3 = c0tx3 + 1; }
     if ((method == "GET") && (path == "/c0tx3=DN"))  { c0tx3 = c0tx3 - 1; }
   ...
   script += "<a href=\"/c0reset\"><button style=\"height:35px;width:70px\"> reset </button></a>";
   script += "<thead><tr>";
...
void handleClients() {
   ...
   if (msgtok != "") {
      c0outMon1 = c0out1 = msgtok.toInt();  // workround
   }
   
   msgtok = webserver.arg("c0out2"); // <<<< c3h2
   if (msgtok != "") {
      c0outMon2 = c0out2 = msgtok.toInt();
   }
   
   msgtok = webserver.arg("c0out3"); // <<<< c3h2
   if (msgtok != "") {
      c0outMon3 = c0out3 = msgtok.toInt();
   }
