...
// History:
// 0.8.1 stringEx.h
// 0.8.0 WiFi.config(this_ip, gateway, subnet, gateway, gateway );
// 0.7.9 neu c2out1, c2out2
...
String c0OUT1name = "1-F.TÜR";   // c0out  output name (c0out = intern)
String c0OUT2name = "2-PUMPE";
String c0OUT3name = "3-KLIMA";

String c1OUT1name = "1-F.TÜR";   // c1out  output name  
String c1OUT2name = "2-F.TÜR";

String c2OUT1name = "1-F.TÜR";   // c2out  output name  
...
void printUrlArg() {
  ...
  String message = "";
  for (uint8_t i = 0; i < lanserver.args(); i++) {
    message += " " + lanserver.argName(i) + ": " + lanserver.arg(i) + "\n";
  }
...
void handleClients() {
  ...
  msgtok = lanserver.arg("c0t1"); // <<<< c0t1
  ftmp = fINVAL;
  if (msgtok != "") {
    ftmp = msgtok.toFloat();
  }
  ...
  msgtok = lanserver.arg("c0h1"); // <<<< c0h1
  ftmp = fINVAL;
  if (msgtok != "") {
    ftmp = msgtok.toFloat();
  }
  ...
  msgtok = lanserver.arg("c0t2"); // <<<< c0t2
  ftmp = fINVAL;
  if (msgtok != "") {
    ftmp = msgtok.toFloat();
  }
  ...
  msgtok = lanserver.arg("c0h2"); // <<<< c0h2
  ftmp = fINVAL;
  if (msgtok != "") {
    ftmp = msgtok.toFloat();
  }
  ...
  msgtok = lanserver.arg("c0p1"); // <<<< c0p1
  ftmp = fINVAL;
  if (msgtok != "") {
    ftmp = msgtok.toFloat();
  }
  ...
  msgtok = lanserver.arg("c0espA0"); // <<<< c0espA0
  ftmp = fINVAL;
  if (msgtok != "") {
    ftmp = msgtok.toFloat();
  }
  ...
  msgtok = lanserver.arg("c0adc0"); // <<<< c0adc0
  ftmp = fINVAL;
  if (msgtok != "") {
    ftmp = msgtok.toFloat();
  }
  ...
  msgtok = lanserver.arg("c0adc1"); // <<<< c0adc1
  ftmp = fINVAL;
  if (msgtok != "") {
    ftmp = msgtok.toFloat();
  }
  ...
  msgtok = lanserver.arg("c0adc2"); // <<<< c0adc2
  ftmp = fINVAL;
  if (msgtok != "") {
    ftmp = msgtok.toFloat();
  }
  ...
  msgtok = lanserver.arg("c0adc3"); // <<<< c0adc3
  ftmp = fINVAL;
  if (msgtok != "") {
    ftmp = msgtok.toFloat();
  }
  ...
  msgtok = lanserver.arg("c1t1"); // <<<< c1t1
  ftmp = fINVAL;
  if (msgtok != "") {
    ftmp = msgtok.toFloat();
  }
  ...
  msgtok = lanserver.arg("c1h1"); // <<<< c1h1
  ftmp = fINVAL;
  if (msgtok != "") {
    ftmp = msgtok.toFloat();
  }
  ...
  msgtok = lanserver.arg("c1t2"); // <<<< c1t2
  ftmp = fINVAL;
  if (msgtok != "") {
    ftmp = msgtok.toFloat();
  }
  ...
  msgtok = lanserver.arg("c1h2"); // <<<< c1h2
  ftmp = fINVAL;
  if (msgtok != "") {
    ftmp = msgtok.toFloat();
  }
  ...
  msgtok = lanserver.arg("c2LocAlive"); // <<<< c2 alive btn pressed?
  if (msgtok != "") {
  ...
  msgtok = lanserver.arg("c2t1"); // <<<< c2t1
  ftmp = fINVAL;
  if (msgtok != "") {
    ftmp = msgtok.toFloat();
  }
  ...
  msgtok = lanserver.arg("c2h1"); // <<<< c2h1
  ftmp = fINVAL;
  if (msgtok != "") {
    ftmp = msgtok.toFloat();
  }
  ...
  msgtok = lanserver.arg("c2t2"); // <<<< c2t2
  ftmp = fINVAL;
  if (msgtok != "") {
    ftmp = msgtok.toFloat();
  }
  ...
  msgtok = lanserver.arg("c2h2"); // <<<< c2h2
  ftmp = fINVAL;
  if (msgtok != "") {
    ftmp = msgtok.toFloat();
  }
