...
int8     LocalAlive=0;
int      emergencycnt=0;      // sensor alarm
int      RemindCnt=99;   // remind
...
char * dashboard(int mode) {
  ...
  if(mode==1) {   
       ...
       display.setCursor( 0,26);  display.print("1." + (String)c1t1.sact +  "*C");       
          //display.setCursor(75,26);  display.print("F:"+(String)c1h1.sact );
       display.setCursor( 0,39);  display.print("2." + (String)c1t2.sact +  "*C" );       
