...
//
// History:
// 0.9.h:  statt request.indexOf() jetzt path== 
...
String htmlButton(String Shref, String Label, int h, int w) {  // specimen
   String buf="";
