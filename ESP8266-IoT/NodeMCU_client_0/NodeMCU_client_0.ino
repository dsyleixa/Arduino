/*  ESP8266 NodeMCU
    ...
    Client 0, Port 8081, wifi server .200
...
// change log
// 0.016  reboot after svr timeout > 30min
//        a: calADC1023, c0espA0
// 0.015c svr loop delays 2000ms
...
static vlog c0t1, c0h1, c0t2, c0h2,  // local temperature, humidity
       c0p1, c0q1, c0espA0;          // local barometr.air pressure, quality
...
void loop() {
   ...
   xadc0 = ADSx48.readADC_SingleEnded(0);  fadc0=calADS16k(xadc0);
   xadc1 = ADSx48.readADC_SingleEnded(1);  fadc1=calADS16k(xadc1);
   xadc2 = ADSx48.readADC_SingleEnded(2);  fadc2=calADS16k(xadc2);
   xadc3 = ADSx48.readADC_SingleEnded(3);  fadc3=calADS16k(xadc3);
